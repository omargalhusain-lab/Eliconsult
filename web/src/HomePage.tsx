...
import trainingModel from "./assets/site-assets/training-model.jpg";
    ...
    <main>
      <section className="hero" id="home">
        ...
        <div
          ...
          style={{ "--hero-bg": cssUrl(heroDubaiNight) } as AssetStyle}
        />
      ...
      <section className="story-section">
        <div
          className="story-bg"
          style={{ "--story-bg": cssUrl(storyDubaiDay) } as AssetStyle}
        />
